...
<style>
  ...
  .rsc-alert-success {
    background: #E8F5EE; border: 1px solid #A7D5B8; color: #1A5C35;
  }
  .rsc-alert-error {
...
<div class="rsc-wrap">
  ...
  <div class="page-header">
    <h2><span class="accent-dot"></span>Approval Withdrawal</h2>
    <p>Kelola seluruh pengajuan pencairan dana Event Organizer</p>
  </div>
  ...
  <div class="filter-box">
    <form action="{{ route('owner.withdrawals.index') }}" method="GET" class="filter-form">
      ...
      @if(request('event_id'))
        <a href="{{ route('owner.withdrawals.index') }}" class="btn-reset">Reset</a>
      @endif
    </form>
  </div>
  ...
  <div class="stats-row">
    ...
    {{-- KARTU SALDO DINAMIS YANG MENGIKUTI FILTER SELEKSI --}}
    <div class="stat-card accent">
      <div>
        ...
        <div class="stat-value">Rp{{ number_format($totalAvailableBalance, 0, ',', '.') }}</div>
